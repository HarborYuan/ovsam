...
from projects.rwkvsam.evaluation.coco_boundary_metric import CocoBoundaryMetric

try:
    from ext.boundary_iou.lvis_instance_api.eval import LVISEval
    from ext.boundary_iou.lvis_instance_api.lvis import LVIS
    from ext.boundary_iou.lvis_instance_api.results import LVISResults
    lvis = "lvis"
except ImportError:
    lvis = None
    LVISEval = None
...
class LVISBoundaryMetric(CocoBoundaryMetric):
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        for metric in self.metrics:
            ...
            lvis_eval = LVISEval(lvis_gt, lvis_dt, 'boundary' if iou_type=='segm' else iou_type)
