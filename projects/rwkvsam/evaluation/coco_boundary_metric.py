...
# Change to boundary iou
from projects.rwkvsam.evaluation.api_wrappers.coco_api import COCO, COCOeval


@METRICS.register_module()
class CocoBoundaryMetric(BaseMetric):
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        for metric in self.metrics:
            ...
            coco_eval = COCOeval(self._coco_api, coco_dt, 'boundary' if iou_type=='segm' else iou_type)
